...
export default function GameBoard({state}:{state:GameState}){
  return <div className="board"><svg viewBox={SWEDEN_VIEWBOX} preserveAspectRatio="xMidYMid meet">
    ...
    <path d={SWEDEN_OUTLINE_PATH} fill="url(#land)" stroke="#3b7f78" strokeWidth="1.4"/><path d={GOTLAND_PATH} fill="#123733" stroke="#3b7f78"/><path d={OLAND_PATH} fill="#123733" stroke="#3b7f78"/>
